...
GetSat forked this gem as the upstream has not seen any changes since 12/2013.

We've added patches from various forks that upgrade Stretcher to update some of it's dependencies (Hashie, Faraday) and to support Elasticsearch 1.0.

If many of these make it back into mainline, lets switch back
